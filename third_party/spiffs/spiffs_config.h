...
//启用或禁用 spiff 的写入缓存。强烈建议启用此功能。否则，请确保存储数据块，而不是写入单个字节。后者，没有，将磨损闪存，因为所有写入都是直接写入的
#endif
...
#define SPIFFS_CFG_PHYS_ERASE_SZ(ignore)  (4096)  //64KByte
#endif
#ifndef SPIFFS_CFG_PHYS_ADDR
#define SPIFFS_CFG_PHYS_ADDR(ignore)      (0)  // 将所有 SPI 闪存都用于 spiff，则此项为0
#endif
#ifndef SPIFFS_CFG_LOG_PAGE_SZ
#define SPIFFS_CFG_LOG_PAGE_SZ(ignore)    (256)  //256byte一个页
#endif
#ifndef SPIFFS_CFG_LOG_BLOCK_SZ
#define SPIFFS_CFG_LOG_BLOCK_SZ(ignore)   (4096)//64KByte
#endif
#endif
